...
# cpk = 7 ** ck mod 20201227.
# dpk = 7 ** dk mod 20201227.
# ek = dpk ** ck mod 20201227 = cpk ** dk mod 20201227.
# ek = 7 ** (dk * ck) mod 20201227.

candidate = 1
for loop_size in itertools.count(1):
    candidate = (candidate * 7) % 20201227
    if candidate == cpk:
        # ck == loop_size
        ...
        # dk == loop_size
        print(pow(cpk, loop_size, 20201227))
        break
    if loop_size % 1000 == 0 and '-v' in sys.argv:
        print(loop_size)

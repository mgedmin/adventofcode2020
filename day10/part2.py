...
ways = [1] + [0] * target_joltage

for adapter in adapters:
    for diff in 1, 2, 3:
        source_joltage = adapter - diff
        if source_joltage >= 0 and ways[source_joltage] > 0:
            ways[adapter] += ways[source_joltage]
ways[target_joltage] = ways[target_joltage - 3]

print(ways[target_joltage])
